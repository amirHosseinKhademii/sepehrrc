...
export const ICBannerStyleThird: FC<ISvg> = ({
  className,
  onClick,
  height,
  width,
  ...
  return (
    <svg
      ...
      onClick={onClick}
    >
      <g id="Banner-Style-3" transform="translate(-630 -602)">
        <g
          id="Group_1421"
          data-name="Group 1421"
          transform="translate(296 312)"
        >
          <g
            id="Group_1299"
