...
export const ICBannerStyleFifth: FC<ISvg> = ({
  className,
  onClick,
  height,
  width,
  ...
  return (
    <svg
      ...
      onClick={onClick}
    >
      <g id="Banner-Style-5" transform="translate(-1158 -602)">
        <g
          id="Group_1418"
          data-name="Group 1418"
          transform="translate(824 312)"
        >
          <g
            id="Group_1299"
          ...
          <path
            ...
            transform="translate(353.133 292.5)"
            fill="#36a7ff"
          />
        </g>
        <g
