...
const HeaderThird: FC<IStyleBoxHeader> = ({
  className,
  onClick,
  active = false,
  toggle,
  ...
  return (
    ...
    >
      <div
        className={toggle(
          `flex  ${flexDirection} items-center h-27px w-full px-9px`,
          'bg-primary-700',
          active,
      ...
      >
        ...
        <BlueBox
          active={active}
          toggle={toggle}
          className={`w-80px h-9px ${marginRtl}-40px rounded-5px`}
        />
        <BlueBox
          active={active}
          toggle={toggle}
          className={`w-30px h-9px ${marginRtl}-40px rounded-7px`}
        />
      </div>
      <BlueBox
        active={active}
